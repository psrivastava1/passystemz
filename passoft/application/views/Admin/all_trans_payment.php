  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <div class="card">
        ...
        <center><h2 class="heading text-primary">Payment Matching </h2></center>
        </div>
                ...
                <div class="row">
                       <div class="col-md-3">
                        ...
                        <?php endforeach;} ?>
                            ...
                            <div class="form-group">
                        <label><strong>Sub Branch Name</strong></label>
                            ...
                            <div class="col-md-6" id="dateselect">
                                <div class="row">
                                     <?php 
                       	       $delivery=$this->db->get('delivery_boy');
    ...
    $("#enddate").change(function(){
      ...
      $.post("<?php echo site_url("wallet/remainingamount")?>",{sbranchid:sbranchid,branchid:branchid,enddate:enddate,delivery:delivery},function(data){

	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel-heading panel-red">
					<h4 class="panel-title"> <span class="text-bold">Registered Permanent Subscriber List</span></h4>
				...
				<div class="panel-body">
                    ...
                    <h4 class="media-heading text-center">Registered Permanent Subscriber List </h4>
					...
					<div class="row">
						<div class="col-md-12 space20">
							<div class="btn-group pull-right">
								...
								<ul class="dropdown-menu dropdown-light pull-right">
									<li>-->
										<a href="#" class="export-pdf" data-table="#subscriberList2" >
											Save as PDF
										</a>
									</li>
									<li>
										<a href="#" class="export-png" data-table="#subscriberList2">
											Save as PNG
										</a>
									</li>
									<li>
										<a href="#" class="export-csv" data-table="#subscriberList2" >
											Save as CSV
										</a>
									</li>
									<li>
										<a href="#" class="export-txt" data-table="#subscriberList2" >
											Save as TXT
										</a>
									</li>
									<li>
										<a href="#" class="export-xml" data-table="#subscriberList2" >
											Save as XML
										</a>
									</li>
									<li>
										<a href="#" class="export-sql" data-table="#subscriberList2" >
										Save as SQL
										</a>
									
									
										<a href="#" class="export-json" data-table="#subscriberList2" >
											Save as JSON
										</a>
									<li>
										<a href="#" class="export-excel" data-table="#subscriberList2" >
											Export to Excel
										</a>
									</li>
									<li>
										<a href="#" class="export-doc" data-table="#subscriberList2" >
										Export to Word
									</a>
									</li>
									<li>
										<a href="#" class="export-powerpoint" data-table="#subscriberList2">
						...
						<div class="table-responsive">
							<table class="table table-striped table-hover" id="subscriberList2">
								<thead>
								<tr>
                                <th>#</th>

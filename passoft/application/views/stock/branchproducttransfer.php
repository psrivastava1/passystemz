          ...
          <div class="row">
            <div class="col-md-6" id="senderpanel">
              ...
              <h6> SENDER </h6>
                ...
                <select class="form-control text-primary" id="checkid" style="height:40px;">
            <option value="">--Select---</option>
             <?php if($view->num_rows()>0){
                 $view1 = $view->row();
                      ?>
          
            <option value="1">Branch <span style="color:green;"><?php echo "[".$view1->b_name."]"; ?></span></option>
             <?php }?>
          </select>
                </div>
              </div>
              ...
              <div class="card bg-c-pink update-card">
                <div class="card-block">
                  <select class="form-control" id="sendcheckid" style="height:40px;">
                    ...
                    <option value="3">Sub Branch</option>
                  </select>
                </div>
            ...
            <div class="col-md-7" id="adminproduct">
              ...
              <div class="panel panel-yellow  table-striped">
                ...
                <table id="alt-pg-dt" class="table table-bordered">
                  <thead>
                    <tr>
                  ...
                  foreach($dt->result() as $row):?>
                    <tr class="text-uppercase">
                      ...
                      <td style="width:10px;"><?php echo $row->hsn?>
                        <input type="hidden" name="adp_code" id="adp_code<?php echo $i;?>"
            ...
            <div class="col-md-5 panel panel-pink update-card" id="branchproduct">
            </div>

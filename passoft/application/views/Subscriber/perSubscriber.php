			...
			<div class="panel-heading panel-red">
				...
				<div class="panel-body">
				    			<div class="alert btn-purple">
                                    ...
                                    <h4 class="media-heading text-center">Welcome to Registered Permanent Subscriber  List </h4>
                                <p>Now you can see Permanent Subscriber List.<br>
                                    </p> </div>
                ...
                <tr class="text-uppercase text-center">
                  ...
                  <td> <?php if($row->tstatus==1){
                    ?><a href=""> <div style="color:#46b92b;"><i class="btn btn-info"><?php echo "Temporary Active";?></i></div></a>
                    <?php

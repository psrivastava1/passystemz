	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel-heading panel-red">
					<h4 class="panel-title"> <span class="text-bold">Payment</span></h4>
				    ...
				    <div class="row">
						...
						<script>
							$("#sub_1").click(function(){
								...
								// alert(uname);
								<?php if($this->session->userdata("login_type")==1) { ?>
								$.post("<?= site_url();?>adminController/payment_record",{uname:uname},function(data){
									$("#show_1").html(data);
								});
							<?php } elseif($this->session->userdata("login_type")==2) { ?>
								$.post("<?= site_url();?>branchController/payment_record",{uname:uname},function(data){
									$("#show_1").html(data);
								});
							<?php } elseif($this->session->userdata("login_type")==4) { ?>
								$.post("<?= site_url();?>shopController/payment_record",{uname:uname},function(data){
									$("#show_1").html(data);
								});
							<?php } ?>
							});

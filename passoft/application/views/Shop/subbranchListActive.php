	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel-heading panel-red">
					<h4 class="panel-title"> <span class="text-bold">Registered Active Shop List</span></h4>
...
<p>Now you can Inactive a Shop By clicking given Active Button in concern row. Or Delete button to delete shop.<br>
</p> </div>
						...
						<div class="col-md-12 space20">
							<div class="btn-group pull-right">
								...
								<ul class="dropdown-menu dropdown-light pull-right">
									...
									<!--</li>-->
									<!--<li>-->
									<!--	<a href="#" class="export-png" data-table="#subBranchList">-->
									<!--		Save as PNG-->
									<!--	</a>-->
									<!--</li>-->
									<!--<li>-->
									<!--	<a href="#" class="export-csv" data-table="#subBranchList" >-->
									<!--		Save as CSV-->
									<!--	</a>-->
									<!--</li>-->
									<!--<li>-->
									...
									<!--</li>-->
									<!--<li>-->
									<!--	<a href="#" class="export-xml" data-table="#subBranchList" >-->
									<!--		Save as XML-->
									<!--	</a>-->
									<!--</li>-->
									<!--<li>-->
									<!--	<a href="#" class="export-sql" data-table="#subBranchList" >-->
									<!--	Save as SQL-->
									<!--	</a>-->
									<!--</li>-->
									<!--<li>-->
									
									<!--	<a href="#" class="export-json" data-table="#subBranchList" >-->
									<!--		Save as JSON-->
									<!--	</a></li>-->
									<li>
									...
									<!--</li>-->
									<!--<li>-->
									<!--	<a href="#" class="export-powerpoint" data-table="#subBranchList">-->
                ...
                <tr class="text-uppercase text-center">
                  ...
                  $br_dt = $this->db->get('branch');
                  ?>
                  <td><?php if($br_dt->num_rows()>0){ echo $br_dt->row()->b_name; } else { echo "N/A"; } ?></td>
                  <td><?php echo $row->mob_no;?></td>
                  <!--<td><?php //echo $row->adhar_no;?></td>-->
				<td><?php $bid= $row->district;	$this->db->where('id',$bid);
				 $view1=$this->db->get('branch');if($view1->num_rows()>0) {echo $view1->row()->b_name;} else { echo "N/A";}?></td>
				<td><?php echo $row->bname;?></td>
                  ...
                  <td><a href="<?php echo base_url();?>index.php/shopController/sbranchfull_profile/<?php echo $row->id;?>"><i class="fa fa-user" style="font-size:28px; color:green;"></i></a>

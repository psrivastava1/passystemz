                            ...
                            <div class="col-sm-12">
                                <table >
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><span style="margin-left:10px;">Company Name :-<strong>Pass System </strong></span></td>

                                        </tr>
                                        <tr>
                                            <td><span style="margin-left:10px;">W2/618,JUHI KALAN DAMODAR NAGAR BARRA 
                                            </span>  <br>
                                            <span style="margin-left:10px;"> 208027 </span>
                                          </td>
                                        </tr>
                                        <tr>
                                    <td><span class="__cf_email__"
                                        data-cfemail="6206070f0d22050f030b0e4c010d0f" style="margin-left:10px;">Email :-<strong>passystem1@gmail.com</strong></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><span style="margin-left:10px;">+91 7084175885</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="card-block">
                    <div class="row invoive-info">
                        <div class="col-md-4 col-xs-12 invoice-client-info">
                            ...
                            <?php   $this->db->where('order_no',$order_no);
                        ...
                        <div class="col-md-4 col-sm-6">
                            <h6 class="m-b-20">Invoice Number : <span class="text-primary"><?php echo $custusr->invoice_no;?></span></h6>
                             <?php 
                           ...
                           ?>
                            <h6 class="text-uppercase">Total Amount:
                                <span class="text-primary"><?php echo $dt1->subtotal;?></span>
                            </h6>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <h6 class="m-b-20 ">Delivery Detail -<br>Address:-<span class="text-primary"><?php echo $custusr->deliver_address;?></span></h6>
                             <?php 
                              $this->db->where('cust_id',$custusr->cust_id);
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <p>This is Shop Computer Generated invoice for Delivery Boy to Deliver the Order to the Subscriber</p>
                        </div>
                    </div>
                </div>
            </div>

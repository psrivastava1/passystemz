						...
						<div class="col-md-12 space20">
							<div class="btn-group pull-right">
								...
								<ul class="dropdown-menu dropdown-light pull-right">
									...
									<!--</li>-->
									<li>
										<a href="#" class="export-excel" data-table="#example">
											Export to Excel
										</a>
									</li>
									<li>
										<a href="#" class="export-doc" data-table="#example">
										Export to Word
									</a>
									</li>
									<li>
    ...
    <center><div><a href="<?php echo base_url();?>shopController/sborder" class="btn btn-success"><span style="font-size:35px;">Done</span></a></div></center>
</div>
</div>
</div>
</div>

...
<p>Now you can Active a Branch By clicking given inactive Button in consern row.<br>
</p> </div>
                ...
                <tr class="text-uppercase text-center">
                  ...
                  <td><button id="changeStatus<?php echo $i;?>" class ="btn btn-warning">
				  <?php if($row->status==1){echo "Active";} else{echo "Inactive";}?></button></td>

<!-- end: EXPORT DATA TABLE PANEL -->
		...
		<script>
			jQuery(document).ready(function() {
				$('#otherdemlist').DataTable();
				$('#orderlist1').DataTable();
				
					$('#subscriberList').DataTable();
					$('#stocklist').DataTable();
					$('#stocklist1').DataTable();
					$('#emptable').DataTable();
						$('#paymentdetail').DataTable();
						$('#sbdemlist1').DataTable();
							$('#sbdemlist4').DataTable();
								$('#sbdemlist5').DataTable();
							$('#subdemlist3').DataTable();
								$('#subscriberList2').DataTable();
			...
			$('#fvlist').DataTable();
				...
				$('#bstocklist').DataTable();
				$('#sbstocklist').DataTable();
			...
			$('#empsubbranch').change(function(){
				...
				//alert(empsubbranch);
				$.post("<?php echo site_url("employeeController/emplist") ?>",{empsubbranch : empsubbranch}, function(data){
						$("#emplist").html(data);
						});
			});

			$('#empbranch1').change(function(){
				var branch = $('#empbranch1').val();
				//alert(branch);
				$.post("<?php echo site_url("employeeController/subBranch1") ?>",{branch : branch}, function(data){
						$("#empsubbranch1").html(data);
						});
			});
			$('#empsubbranch1').change(function(){
				var empsubbranch = $('#empsubbranch1').val();
				//alert(empsubbranch);
				$.post("<?php echo site_url("employeeController/emplist1") ?>",{empsubbranch : empsubbranch}, function(data){
						$("#emplist1").html(data);
						});
			});

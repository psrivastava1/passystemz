<!-- start: MAIN JAVASCRIPTS -->
 ...
 //alert(adhar);
$.post("<?php echo site_url('shopController/match_adhar_shop') ?>", {adhar : adhar
        }, function(data){
            $('#aadharmsg').html(data);
...
$('#sbname').change(function(){
 var adhar = $('#sbname').val();
 //alert(adhar);
$.post("<?php echo site_url('shopController/match_name_shop') ?>", {adhar : adhar
        }, function(data){
            $('#namemsg').html(data);
            document.getElementById("subbutton").disabled = false;
       });
 ...
 //alert(panVal);
 $.post("<?php echo site_url('branchController/match_pan1') ?>", {panVal : panVal}, function(data){

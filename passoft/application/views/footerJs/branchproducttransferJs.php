...
$(document).ready(function() {
  $('#enddate').hide();
   $('#branchid').change(function(){
     ...
     // alert(branch);
      $.post("<?php echo site_url("branchController/getsubpayment")?>",{branch:branch},function(data){
          // $('#showsubbranch').show();
      $('#sbranchid').html(data);
   ...
   $('#sbranchid').change(function(){
    var sbranch = $('#sbranchid').val();
   // alert(sbranch);
      $.post("<?php echo site_url("branchController/getemptype")?>",{sbranch:sbranch},function(data){
      $('#delevryid').html(data);
    
      });
   });
   $('#delevryid').change(function(){
 $('#enddate').show();
   });
    ...
    $("#enddate").change(function(){
       ...
       var delivery=$("#delevryid").val();
       if(sbranchid!=" " && branchid!=" " && delivery!="" && enddate!=""){
      $.post("<?php echo site_url("branchController/remainingamount")?>",{sbranchid:sbranchid,branchid:branchid,enddate:enddate,delivery:delivery},function(data){
